...
<body>
  ...
  <form id="frm" class="mb-3" method="POST" enctype="multipart/form-data">
    <video id="video" width="300" width="720" height="300" autoplay muted></video>
    ...
    <div class="container-xxl">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <!-- Register Card -->
          <button class="btn btn-primary d-grid w-100 mx-auto" type="button" id="tomar-captura">Tomar Captura</button>
          <div class="card">
            <div class="card-body">
              <!-- Logo -->
